            ...
            <div class="bg-layer">
                ...
                <div class="header-main">
                    ...
                    <div class="header-left-bottom">
                            {!! Form::open(['action' => 'loginController@AccesoUsuario', 'method' => 'post', 'enctype' => 'multipart/form-data','class' => 'login100-form validate-form','autocomplete'=>'off']) !!}
                            <fieldset>
                                ...
                                <div class="text-center p-t-12">
                                    <a class="txt2" href="#" data-toggle="modal" data-target="#modal-rcontrasena-final">
                                    <span class="txt1">
