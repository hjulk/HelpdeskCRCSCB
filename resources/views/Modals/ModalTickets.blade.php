            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div align="right"><small class="text-muted" style="font-size: 1.5vh;">Por favor copiar texto sin <b>íconos</b> que vienen en el correo. Gracias</small> <span id="cntDescripHechos" align="right"> </span></div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="file" id="evidencia[]" name="evidencia[]" class="form-control" multiple="multiple" size="10200">
