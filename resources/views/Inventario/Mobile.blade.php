    ...
    <div class="row">
        <div class="box box-success">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#modal-mobile">Ingresar Equipo Móvil</button>
                        <br>
                        <br>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach($EquiposMoviles as $value)
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><a href="#" class="btn btn-warning" title="Editar" data-toggle="modal" data-target="#modal-cambios-mobile" onclick="obtener_datos_mobile('{{$value['id']}}');"><i class="fa fa-edit"></i></a></td>
                                        ...
                                        <input type="hidden" value="{{$value['botones']}}" id="botones{{$value['id']}}">
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
